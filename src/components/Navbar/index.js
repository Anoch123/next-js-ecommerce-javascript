...
const Navbar = () => {
  ...
  return (
    <>
        <nav className='flexBetween navbar bg-[#fdfdfd]'>
                    ...
                    isAuthUser ? (
                        <>
                            <div className="group relative">
                                ...
                                {isAuthUser && (
                                    <div className="opacity-0 invisible absolute top-full right-0 group-hover:opacity-100 group-hover:visible zindex">
